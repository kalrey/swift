...
from swift.obj.backend.hbase.HbaseClient.ttypes import *
...
class Processor(Iface, TProcessor):
  ...
  def process_getRowWithColumns(self, seqid, iprot, oprot):
    ...
    try:
      ...
      result.io = io
    except HbaseThriftException, hte:
      result.hte = hte
...
class getRowWithColumns_result:
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(TRowResult, TRowResult.thrift_spec)), None, ), # 0
    (1, TType.STRUCT, 'io', (IOError, IOError.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'hte', (HbaseThriftException, HbaseThriftException.thrift_spec), None, ), # 2
  )

  def __init__(self, success=None, io=None, hte=None,):
    self.success = success
    self.io = io
    self.hte = hte
  ...
  def write(self, oprot):
    ...
    if self.io is not None:
      ...
      self.io.write(oprot)
      oprot.writeFieldEnd()
    if self.hte is not None:
      oprot.writeFieldBegin('hte', TType.STRUCT, 2)
      self.hte.write(oprot)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class mutateRow_result:
  ...
  thrift_spec = (
    ...
    (1, TType.STRUCT, 'io', (IOError, IOError.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'ia', (IllegalArgument, IllegalArgument.thrift_spec), None, ), # 2
    (3, TType.STRUCT, 'hte', (HbaseThriftException, HbaseThriftException.thrift_spec), None, ), # 3
  )

  def __init__(self, io=None, ia=None, hte=None,):
    self.io = io
    self.ia = ia
    self.hte = hte
  ...
  def write(self, oprot):
    ...
    if self.ia is not None:
      ...
      oprot.writeFieldEnd()
    if self.hte is not None:
      oprot.writeFieldBegin('hte', TType.STRUCT, 3)
      self.hte.write(oprot)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
...
class deleteAll_result:
  ...
  def __init__(self, io=None, hte=None,):
    self.io = io
    self.hte = hte
