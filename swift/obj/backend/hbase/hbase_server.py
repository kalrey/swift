...
from swift.obj.backend.hbase.hbase_diskfile import HbaseBackend
...
class ObjectController(server.ObjectController):
    ...
    def setup(self, conf):
        """
        Nothing specific to do for the hbase version.
    ...
    def get_diskfile(self, table, partition, account, container, obj,
        ...
        behavior.
        """
        return self._hbase_backend.get_diskfile(table, account, container, obj, **kwargs)
