...
class HbaseThriftErrorCode:
  HBASE_THRIFT_SUCCESS = 0
  RPC_ERROR_BASE = 33000
  HBASE_THRIFT_BUILDMESSAGE_ERROR = 33001
  HBASE_MRT_NULL_MESSAGE = 33002
  HBASE_THRIFT_PUT_MESSAGE_ERROR = 33003
  HBASE_TABLE_NOT_EXIST = 33004
  HBASE_MTR_PRODUCE_FAILURE = 33005
  HBASE_THRIFT_ILLEGALARGUMENT = 33006
  HBASE_THRIFT_IOERROR = 33007
  HBASE_THRIFT_ALREADY_EXISTS = 33008
  HBASE_MTR_NO_RMQTHRIFT = 33009
  HBASE_MTR_SUB_OR_TOPIC_NOT_EXIST = 33010

  _VALUES_TO_NAMES = {
    0: "HBASE_THRIFT_SUCCESS",
    33000: "RPC_ERROR_BASE",
    33001: "HBASE_THRIFT_BUILDMESSAGE_ERROR",
    33002: "HBASE_MRT_NULL_MESSAGE",
    33003: "HBASE_THRIFT_PUT_MESSAGE_ERROR",
    33004: "HBASE_TABLE_NOT_EXIST",
    33005: "HBASE_MTR_PRODUCE_FAILURE",
    33006: "HBASE_THRIFT_ILLEGALARGUMENT",
    33007: "HBASE_THRIFT_IOERROR",
    33008: "HBASE_THRIFT_ALREADY_EXISTS",
    33009: "HBASE_MTR_NO_RMQTHRIFT",
    33010: "HBASE_MTR_SUB_OR_TOPIC_NOT_EXIST",
  }
...
class HbaseThriftException(TException):
  """
  Attributes:
   - id
   - msg
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      ...
      return
    oprot.writeStructBegin('HbaseThriftException')
