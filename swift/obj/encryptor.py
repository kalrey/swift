...
class CryptoDriver(object):
    ...
    def encryption_context(self, key):
        """
...
class M2CryptoDriver(CryptoDriver):
    ...
    """
    # AES 256
    default_protocol = 'aes_256_cbc'
    default_iv = '15eed0f73adaf6c54a859587e53c8cb8'

    # AES 128
    # default_protocol = 'aes_128_cbc'
    # default_iv = '15eed0f73adaf6c5'

    def __init__(self, conf, key):
        CryptoDriver.__init__(self, conf, key)
        self.protocol = conf.get('crypto_protocol', self.default_protocol)
        #TODO(ikharin): Now supported only aes_256_cbc protocol.
    ...
    def encryption_context(self, key):
        ...
        :returns: encryption context
        """
        context = super(M2CryptoDriver, self).encryption_context(key)
